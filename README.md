...
See [docs/tmux-statusbar.md](docs/tmux-statusbar.md) for details on the status bar layout.
...
| Doc | Description |
|-----|-------------|
| [tmux-statusbar.md](docs/tmux-statusbar.md) | Status bar layout and customization |
| [tmux-second-status-line.md](docs/tmux-second-status-line.md) | Second status line details (rig overview) |
| **[CLAUDE.md](CLAUDE.md)** | **Agent-friendly quick reference** |
